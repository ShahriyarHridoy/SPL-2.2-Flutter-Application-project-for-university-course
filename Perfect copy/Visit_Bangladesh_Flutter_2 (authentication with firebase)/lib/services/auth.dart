...
abstract class AuthBase{
  ...
  Future<UserInf> signInWithEmailAndPassword(String email, String password);
  Future<UserInf> createUserWithEmailAndPassword(String email, String password);
}
class Auth implements AuthBase {
  ...
  @override
  Future<UserInf> signInWithEmailAndPassword(String email, String password) async {
  ...
  @override
  Future<UserInf> createUserWithEmailAndPassword(String email, String password,) async {
